...
turtle.pensize(4)                            # Set the border thickness
turtle.penup()                               # Lift the pen to move without drawing
turtle.goto(-310, 250)                       # Position the pen at the starting point
turtle.pendown()                             # Lower the pen to start drawing
turtle.color("red")                          # Set the border color to red

# Draw the rectangular boundary
turtle.forward(600)                          # Draw top border
turtle.right(90)
turtle.forward(500)                          # Draw right border
turtle.right(90)
turtle.forward(600)                          # Draw bottom border
turtle.right(90)
turtle.forward(500)                          # Draw left border
turtle.penup()
